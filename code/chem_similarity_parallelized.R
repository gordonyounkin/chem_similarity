...
sampsByCompounds <- make_sampsByCompounds("./data/filled_compound_table_major_features_2017_11_30.csv", 
                                          by_species = FALSE)
...
write.csv(similarity_matrix_sap, "./results/sap_sim_filled_comps_LOG_2017_11_30.csv")
...
write.csv(similarity_matrix_phen, "./results/phen_sim_filled_comps_LOG_2017_11_30.csv")
