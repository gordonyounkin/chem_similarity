...
with open("K://GY_LAB_FILES//github_repositories//chem_similarity//data//samples_with_polar_features_mzrt.csv", 'w') as file1:
...
with open("K://GY_LAB_FILES//github_repositories//chem_similarity//data//polar_compound_feature_table.csv", "w") as file1:
